...
import { normalizeFullPlan } from "../../supabase/functions/claude-coach/planUtils.ts";
...
function makeAiStyleHierarchicalPlan() {
  return normalizeFullPlan({
    meta: {
    ...
    phases: [
      { name: "Technical Base Building", startDate: "2026-04-06", endDate: "2026-04-20", weeks: 2, focus: "Trail skills development" },
      { name: "Ultra Build", startDate: "2026-04-21", endDate: "2026-05-11", weeks: 3, focus: "Back-to-back long runs" },
      { name: "Peak & Taper", startDate: "2026-05-12", endDate: "2026-05-30", weeks: 3, focus: "Final preparation" },
    ],
    weeks: [
      {
        weekNumber: 1,
        ...
        days: [
          { date: "2026-04-06", dayOfWeek: "Sunday", workouts: [{ id: "w1d1", sport: "running", type: "long", name: "Trail Technique Long Run", durationMinutes: 180, distanceKm: 25, primaryZone: "aerobic", completed: false }] },
      ...
      },
      {
        ...
        days: [
          { date: "2026-04-13", dayOfWeek: "Sunday", workouts: [{ id: "w2d1", sport: "running", type: "long", name: "Extended Trail Long Run", durationMinutes: 210, distanceKm: 28, primaryZone: "aerobic", completed: false }] },
      ...
      },
      {
        ...
        endDate: "2026-04-26",
        phase: "Ultra Build",
        focus: "Back-to-back long runs",
        days: [
          { date: "2026-04-20", dayOfWeek: "Sunday", workouts: [{ id: "w3d1", sport: "running", type: "recovery", name: "Recovery Run", durationMinutes: 40, distanceKm: 7, primaryZone: "recovery", completed: false }] },
      ...
      },
      {
        ...
        focus: "Peak volume",
        days: [
          { date: "2026-04-27", dayOfWeek: "Sunday", workouts: [{ id: "w4d1", sport: "running", type: "long", name: "Back-to-Back Day 2", durationMinutes: 195, distanceKm: 26, primaryZone: "aerobic", completed: false }] },
      ...
      },
      {
        ...
        days: [
          { date: "2026-05-04", dayOfWeek: "Sunday", workouts: [{ id: "w5d1", sport: "running", type: "long", name: "Ultra Race Rehearsal", durationMinutes: 240, distanceKm: 32, primaryZone: "aerobic", completed: false }] },
      ...
      },
      {
        ...
        focus: "Taper start",
        days: [
          { date: "2026-05-11", dayOfWeek: "Sunday", workouts: [{ id: "w6d1", sport: "running", type: "recovery", name: "Recovery Run", durationMinutes: 40, distanceKm: 7, primaryZone: "recovery", completed: false }] },
      ...
      },
      {
        ...
        days: [
          { date: "2026-05-18", dayOfWeek: "Sunday", workouts: [{ id: "w7d1", sport: "running", type: "aerobic", name: "Easy Trail Run", durationMinutes: 75, distanceKm: 12, primaryZone: "aerobic", completed: false }] },
      ...
      },
      {
        ...
        focus: "Race week",
        days: [
          { date: "2026-05-25", dayOfWeek: "Sunday", workouts: [{ id: "w8d1", sport: "running", type: "easy", name: "Easy Run", durationMinutes: 45, distanceKm: 7, primaryZone: "easy", completed: false }] },
          ...
          { date: "2026-05-30", dayOfWeek: "Friday", workouts: [{ id: "w8d6", sport: "running", type: "race", name: "Soria Moria til Verdens Ende Ultra", durationMinutes: 600, distanceKm: 80.5, primaryZone: "race", completed: false }] },
        ],
      },
    ],
    raceStrategy: {
      event: { name: "Soria Moria til Verdens Ende 50 miles", date: "2026-05-30", distance: "80.5km", type: "ultra" },
    },
...
describe("Training Plan — page structure", () => {
  ...
  it("renders normalized AI full plans in the long-term plan viewer", () => {
    useAppData.mockReturnValue(makeAppData({
      hierarchicalPlan: {
        ...
        plan: {
          ...
          user_id: "user-1",
          status: "active",
          plan_data: makeAiStyleHierarchicalPlan(),
        },
      },
    }));
    ...
    expect(screen.getByText("Soria Moria til Verdens Ende 50 miles")).toBeInTheDocument();
    expect(screen.getByTestId("phase-section-technical-base-building-1-2")).toBeInTheDocument();
    expect(screen.getByTestId("week-card-5")).toBeInTheDocument();
  });
