  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-slate-50 to-indigo-50 p-6">
      <div className="bg-white border border-slate-200 rounded-2xl shadow-lg p-10 w-full max-w-sm">
        ...
        <button
          type="button"
          className="w-full border border-slate-200 bg-white rounded-lg px-3 py-2.5 flex items-center justify-center gap-2.5 font-inherit text-sm font-semibold text-slate-900 cursor-pointer hover:bg-slate-50 hover:border-slate-300 transition-colors disabled:opacity-60 disabled:cursor-not-allowed mb-4"
        ...
        <form onSubmit={handleSubmit} className="grid gap-4" noValidate>
          <label className="grid gap-1.5 text-sm font-medium">
            ...
            <input
              type="email"
              className="border border-slate-300 rounded-lg px-3 py-2.5 font-inherit text-sm focus:outline-none focus:border-blue-600 focus:shadow-[0_0_0_3px_rgba(37,99,235,0.15)] transition-shadow disabled:opacity-60"
              value={email}
          ...
          <button
            type="submit"
            className="mt-1 py-3 bg-blue-600 text-white border-0 rounded-lg font-inherit text-sm font-semibold cursor-pointer hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            disabled={submitting}
          >
            {submitting
