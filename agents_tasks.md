...
**Done criteria:**
- [ ] App loads in Norwegian by default (no localStorage entry)
- [ ] Switching language to English in UI persists and shows English
- [ ] Coach page passes `lang` in every edge function call
- [ ] Edge function appends Norwegian/English instruction to all prompts
