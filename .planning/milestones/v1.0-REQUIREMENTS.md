# Requirements Archive: v1.0 Coach Integration + Philosophy Tailoring

**Archived:** 2026-03-08
**Status:** SHIPPED

For next-milestone requirements, create a new `.planning/REQUIREMENTS.md` via `$gsd-new-milestone`.
...
- [x] **RPLN-01**: User can trigger manual long-term replanning from the app and receive updated weekly structure up to goal race.
- [x] **RPLN-02**: Replanning uses latest activities, daily logs, and check-ins as input context.
...
- [x] **PHIL-03**: `gemini-coach` applies active philosophy content at runtime when generating coaching output.
...
|-------------|-------|--------|
| RPLN-01 | Phase 2 | Complete |
| RPLN-02 | Phase 2 | Complete |
| RPLN-03 | Phase 3 | Complete |
| PHIL-01 | Phase 1 | Complete |
| PHIL-02 | Phase 1 | Complete |
| PHIL-03 | Phase 2 | Complete |
...
- Validated and shipped in v1.0: PHIL-01, PHIL-02, PHIL-03, RPLN-01, RPLN-02, RPLN-03, FDBK-01, FDBK-02, INSG-01, INSG-02
- Adjusted during milestone: `INSG-02` moved from Phase 4 initial implementation to Phase 5 hardening closeout
